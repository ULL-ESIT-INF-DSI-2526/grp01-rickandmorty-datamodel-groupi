...
import { menuCrearDimension, menuCrearPersonaje, menuCrearEspecie, menuCrearLocalizacion, menuCrearArtefacto } from "../../src/menu/creacion.js";
...
describe("Menú de creación", () => {
  ...
  describe("menuCrearDimension", () => {
    test("Debería crear una dimensión y guardarla", async () => {
    ...
    test("Debería imprimir un error de validación de ID inválido", async () => {
      vi.mocked(prompts).mockResolvedValueOnce({
  ...
  describe("menuCrearPersonaje", () => {
    test("Debería crear un personaje y guardarlo", async () => {
      vi.mocked(prompts).mockResolvedValueOnce({
    ...
    test("Debería capturar el error de validación de rango de inteligencia", async () => {
      vi.mocked(prompts).mockResolvedValueOnce({
  ...
  describe("menuCrearEspecie", () => {
    test("Debería crear una especie y guardarla", async () => {
      vi.mocked(prompts).mockResolvedValueOnce({
    ...
    test("Debería capturar el error de validación de esperanza de vida negativa", async () => {
      vi.mocked(prompts).mockResolvedValueOnce({
  ...
  describe("menuCrearLocalizacion", () => {
    test("Debería crear una localización y guardarla", async () => {
      vi.mocked(prompts).mockResolvedValueOnce({
    ...
    test("Debería capturar el error de validación de población negativa", async () => {
      vi.mocked(prompts).mockResolvedValueOnce({
  ...
  describe("menuCrearArtefacto", () => {
    test("Debería crear un artefacto y guardarlo", async () => {
      vi.mocked(prompts).mockResolvedValueOnce({
    ...
    test("Debería capturar el error de validación de ID de inventor incorrecto", async () => {
      vi.mocked(prompts).mockResolvedValueOnce({
